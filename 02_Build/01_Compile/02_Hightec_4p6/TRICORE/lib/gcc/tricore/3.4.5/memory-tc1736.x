...
__ISTACK_SIZE = 1K;
__HEAP_MIN = 1K;
__TRICORE_DERIVATE_MEMORY_MAP__ = 0x1736;
...
MEMORY
{
  PMU_PFLASH0 (rx!p): org = 0xa0000000, len = 1M
  ...
  DMI_LDRAM (w!xp): org = 0xd0000000, len = 36K
 ...
 * fit together
*/
_. = ASSERT ((__TRICORE_DERIVATE_MEMORY_MAP__ == __TRICORE_DERIVATE_NAME__), "Using wrong Memory Map. This Map is for TC1736");
