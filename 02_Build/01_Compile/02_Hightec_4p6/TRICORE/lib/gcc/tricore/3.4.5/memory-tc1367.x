...
__ISTACK_SIZE = 1K;
__HEAP_MIN = 32K;
__TRICORE_DERIVATE_MEMORY_MAP__ = 0x1367;
 ...
 * fit together
*/
_. = ASSERT ((__TRICORE_DERIVATE_MEMORY_MAP__ == __TRICORE_DERIVATE_NAME__), "Using wrong Memory Map. This Map is for TC1367");
