...
MEMORY
{
  ...
  PMU_DFLASH0 (w!xp): org = 0xaf000000, len = 32K

  PMU_DFLASH1 (w!xp): org = 0xafe10000, len = 32K

  PMI_SPRAM (rx!p): org = 0xc0000000, len = 24K
  DMI_LDRAM (w!xp): org = 0xd0000000, len = 120K
 ...
 * fit together
*/
_. = ASSERT ((__TRICORE_DERIVATE_MEMORY_MAP__ == __TRICORE_DERIVATE_NAME__), "Using wrong Memory Map. This Map is for TC1724");
