...
__ISTACK_SIZE = 1K;
__HEAP_MIN = 16K;
__TRICORE_DERIVATE_MEMORY_MAP__ = 0x1197;
/* the external RAM description */
__EXT_CODE_RAM_BEGIN = 0x81000000;
__EXT_CODE_RAM_SIZE = 1M ;
__EXT_DATA_RAM_BEGIN = 0x81100000;
 ...
 * fit together
*/
_. = ASSERT ((__TRICORE_DERIVATE_MEMORY_MAP__ == __TRICORE_DERIVATE_NAME__), "Using wrong Memory Map. This Map is for TC1197");
