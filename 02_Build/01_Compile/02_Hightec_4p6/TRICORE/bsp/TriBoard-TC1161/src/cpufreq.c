...
* Developed using:
* Function: Determine the frequency the CPU is running at (TC1161)
*
* Copyright HighTec EDV-Systeme GmbH 1982-2009
*====================================================================*/

#include <machine/wdtcon.h>
#include <tc1161/scu.h>
#include <tc1161/pmi.h>


#ifndef DEF_FRQ
#define DEF_FRQ			15000000U  /* TC1161 quartz frequency is 15 MHz */
#endif /* DEF_FRQ */


/* divider values for 66 MHz */
#define SYS_CFG_KDIV		10
#define SYS_CFG_NDIV		44
...
unsigned int get_cpu_frequency(void)
{
	...
	if (!freq_init)
	{
		/* set speed to 66 MHz with 15MHz Crystal */
		set_cpu_frequency();
