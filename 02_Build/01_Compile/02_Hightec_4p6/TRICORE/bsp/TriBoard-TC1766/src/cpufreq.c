...
* Developed using:
* Function: Determine the frequency the CPU is running at (TC1766)
*
* Copyright HighTec EDV-Systeme GmbH 1982-2009
*====================================================================*/

#include <machine/wdtcon.h>
#include <tc1766b/scu.h>
#include <tc1766b/pmi.h>


#ifndef DEF_FRQ
#define DEF_FRQ			15000000U  /* TC1766 quartz frequency is 15 MHz */
#endif /* DEF_FRQ */


/* divider values for 80 MHz */
#define SYS_CFG_KDIV		 6
#define SYS_CFG_NDIV		32
...
unsigned int get_cpu_frequency(void)
{
	...
	if (!freq_init)
	{
		/* set speed to 80 MHz with 15MHz Crystal */
		set_cpu_frequency();
