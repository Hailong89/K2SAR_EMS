...
* Developed using:
* Function: Determine the frequency the CPU is running at (TC1387)
*
* Copyright HighTec EDV-Systeme GmbH 1982-2010
*====================================================================*/

#include <machine/wdtcon.h>
#include <tc1387/scu.h>
#include <tc1387/cpu.h>


#ifndef DEF_FRQ
#define DEF_FRQ			20000000U	/* TriBoard-TC1387 quartz frequency is 20 MHz */
#endif /* DEF_FRQ */
