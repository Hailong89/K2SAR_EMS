...
* Developed using:
* Function: Determine the frequency the CPU is running at (TC1762)
*
* Copyright HighTec EDV-Systeme GmbH 1982-2009
*====================================================================*/

#include <machine/wdtcon.h>
#include <tc1762/scu.h>
#include <tc1762/pmi.h>


#ifndef DEF_FRQ
#define DEF_FRQ			15000000U  /* TC1762 quartz frequency is 15 MHz */
#endif /* DEF_FRQ */
