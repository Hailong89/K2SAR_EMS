...
* Developed using:
* Function: Determine the frequency the CPU is running at (TC1796)
*
...
#ifndef DEF_FRQ
#define DEF_FRQ			20000000U  /* TC1796 quartz frequency is 20 MHz */
#endif /* DEF_FRQ */


/* divider values for 150 MHz */
/* PLL_TC.H005 TC1796BC-Errata-V1.7: NDIV >= 33 !! */
#define SYS_CFG_KDIV		 4
#define SYS_CFG_NDIV		60
