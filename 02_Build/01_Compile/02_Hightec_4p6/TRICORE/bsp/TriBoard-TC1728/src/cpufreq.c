...
* Developed using:
* Function: Determine the frequency the CPU is running at (TC1728)
*
* Copyright HighTec EDV-Systeme GmbH 1982-2009
*====================================================================*/

#include <machine/wdtcon.h>
#include <tc1728/scu.h>
#include <tc1728/cpu.h>


#ifndef DEF_FRQ
#define DEF_FRQ			20000000U	/* TriBoard-TC1728 quartz frequency is 20 MHz */
#endif /* DEF_FRQ */
