...
* Developed using:
* Function: Determine the frequency the CPU is running at (TC1724)
*
* Copyright HighTec EDV-Systeme GmbH 1982-2009
*====================================================================*/

#include <machine/wdtcon.h>
#include <tc1724/scu.h>
#include <tc1724/cpu.h>


#ifndef DEF_FRQ
#define DEF_FRQ			20000000U	/* TriBoard-TC1724 quartz frequency is 20 MHz */
#endif /* DEF_FRQ */

#define VCOBASE_FREQ	400000000U	/* ?? */

/* divider values for 133 1/3 MHz */
#define SYS_CFG_PDIV	 1
#define SYS_CFG_NDIV	40
#define SYS_CFG_K1DIV	 6
#define SYS_CFG_K2DIV	 6
