...
* Developed using:
* Function: Determine the frequency the CPU is running at (TC1784)
*
* Copyright HighTec EDV-Systeme GmbH 1982-2010
*====================================================================*/

#include <machine/wdtcon.h>
#include <tc1784/scu.h>
#include <tc1784/cpu.h>


#ifndef DEF_FRQ
#define DEF_FRQ			20000000U	/* TriBoard-TC1784 quartz frequency is 20 MHz */
#endif /* DEF_FRQ */
