...
.
+               26377           1397159342 profcount2.mil
#!<mil>
# TASKING VX-toolset for TriCore: C compiler v99.9r9 Build 759
# options: --mil --core=tc1.3 --silicon-bug=all-tc1130 --mmu-present --mmu-on -Rlibpb --section-name-with-symbol -N0 -O3 -g1 --global-type-checking --user-mode=user-0
# files: ..\..\..\..\profcount2.c
#!G__prof_block_entry
#!G__prof_func_entry
#!G__prof_func_entry2
...
-
-
<17:quot 3 3 8 5 30:42 <23:5,-,-,<24:1,int,<12:signed,-,8>>,0,-> - 0 - - 32 0 0>
...
-
-
<20:quot 3 3 8 5 35:48 <26:5,-,-,<27:1,int,<13:signed,-,7>>,0,-> - 0 - - 64 0 0>
...
29:current_count 3 3 8 5 25:46 5 - 40 - - 32 0 0
30:lock 3 3 8 5 :47 5 - 60 - - 32 0 0> 80 - - 32 0 0>>
-
-> - - 8 0 32>
...
-
-
49:.1.nn 4 3 7 1 44 3 - - 42 32 0 0
50:.2.nn 4 3 7 1 52 3 - - 42 32 0 0> <25
4
0
42
59
...
-
-
52:.1.nn 4 3 7 1 44 5 - - - 32 0 0> <27
4
0
42
48
...
58:.2.nn 4 3 7 1 38 5 - - - 32 0 0> <33
4
0
23
41
...
63:.2.nn 4 3 7 1 32 5 - - - 32 0 0
64:.3.nn 4 3 7 1 37 60 - - - 32 0 0
65:.4.nn 4 3 7 1 52 5 - - - 32 0 0> <39
4
0
23
55
...
-
-
80:i 4 3 7 1 25:135 5 - - - 32 0 8
81:max_index 4 3 7 1 :136 5 - - - 32 0 8>
-
...
TAIL -:- 0 -
.
+              662894           1397159343 cstart.mil
#!<mil>
# TASKING VX-toolset for TriCore: C compiler v99.9r9 Build 759
# options: --mil --core=tc1.3 --silicon-bug=all-tc1130 --mmu-present --mmu-on -Rlibpb --section-name-with-symbol -N0 -O3 -g1 --global-type-checking --user-mode=kernel -D__NO_CSTART_REGISTER_CONFIG -pf --core=tc1.3 -D__CPU__=tc1130
# files: ..\..\..\..\cstart.c
#!E__prof_block_entry
#!E__prof_func_entry
#!E__prof_func_entry2
...
TAIL -:- 0 -
.
+               32697           1397159343 prof_io_use_dbg.mil
#!<mil>
# TASKING VX-toolset for TriCore: C compiler v99.9r9 Build 759
# options: --mil --core=tc1.3 --silicon-bug=all-tc1130 --mmu-present --mmu-on -Rlibpb --section-name-with-symbol -N0 -O3 -g1 --global-type-checking --user-mode=user-0
...
TAIL -:- 0 -
.
+               19256           1397159343 prof_io_use_fs.mil
#!<mil>
# TASKING VX-toolset for TriCore: C compiler v99.9r9 Build 759
# options: --mil --core=tc1.3 --silicon-bug=all-tc1130 --mmu-present --mmu-on -Rlibpb --section-name-with-symbol -N0 -O3 -g1 --global-type-checking --user-mode=user-0
