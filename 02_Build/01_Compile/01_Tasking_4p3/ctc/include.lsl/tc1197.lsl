...
//**  FILE        :  tc1197.lsl                                              *
//**                                                                         *
//**  DESCRIPTION :  LSL description: Infineon TC1197*
//**                                                                         *
...
derivative tc1197
{
        ...
        memory pflash1
        {
                ...
                type = rom;
                speed = 2;
                map     cached (dest=bus:tc:fpi_bus, dest_offset=0x80200000,           size=2M);
                map not_cached (dest=bus:tc:fpi_bus, dest_offset=0xa0200000, reserved, size=2M);
        }
