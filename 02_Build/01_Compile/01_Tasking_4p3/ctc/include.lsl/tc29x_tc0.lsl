...
//**  FILE        :  @(#)tc29x.lsl      1.7                                                  *
//**                                                                         *
//**  DESCRIPTION :  LSL description: Infineon TC29X                         *
//**                                                                         *
...
derivative tc29x
{
        ...
        core mcs04      // core mcs04
        {
                architecture = MCS;
                copytable_space = tc0:linear;   // use the copy table in the virtual core for 'bss' and initialized data sections
        }

        core mcs05      // core mcs05
        {
                architecture = MCS;
                copytable_space = tc0:linear;   // use the copy table in the virtual core for 'bss' and initialized data sections
        }
        ...
        memory dspr0 // Data Scratch Pad Ram
        {
                ...
                size = 120k;
                type = ram;
                map (dest=bus:tc0:fpi_bus, dest_offset=0xd0000000, size=120k, priority=2, exec_priority=0);
        ...
        memory pspr0 // Program Scratch Pad Ram
        {
                ...
                size = 32k;
                type = ram;
                map (dest=bus:tc0:fpi_bus, dest_offset=0xc0000000, size=32k, exec_priority=2);
