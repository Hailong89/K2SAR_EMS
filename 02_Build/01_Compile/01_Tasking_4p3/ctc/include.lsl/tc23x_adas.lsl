//****************************************************************************
//**                                                                         *
//**  FILE        :  @(#)tc23x_adas.lsl 1.1 14/02/14                                                 *
//**                                                                         *
//**  DESCRIPTION :  LSL description: Infineon TC23X_ADAS                            *
//**                                                                         *
...
derivative tc23x_adas
{
        ...
        bus sri
        {
                ...
                map (dest=bus:vtc:fpi_bus, src_offset=0, dest_offset=0, size=0x50000000 + 2*0x10000000);
                ...
                map (dest=bus:vtc:fpi_bus, src_offset=0x50000000 + 2*0x10000000, dest_offset=0x50000000 + 2*0x10000000, size=1*0x10000000);
        }
        ...
        memory dspr0 // Data Scratch Pad Ram
        {
                ...
                size = 184k;
                type = ram;
                map (dest=bus:tc0:fpi_bus, dest_offset=0xd0000000, size=184k, priority=1, exec_priority=0);
