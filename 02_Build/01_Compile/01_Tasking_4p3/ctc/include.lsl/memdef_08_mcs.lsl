...
#endif
#ifndef MCS06_0RAM
#define MCS06_0RAM              0x68000
#endif
#ifndef MCS07_0RAM
#define MCS07_0RAM              0x70000
#endif
...
# define __MCS07_OFFSET1                __MCS_RAM0_SIZE

#elif __MCS_BORROW_MEM_MCS(07)
...
# define __MCS06_OFFSET0                __MCS_RAM1_SIZE
# define __MCS05_OFFSET1                __MCS_RAM0_SIZE

#elif __MCS_BORROW_MEM_MCS(05)
# define __MCS06_OFFSET0                0

#endif

// MCS07; (previous=06)
#if __MCS_SWAP_MEM_MCS(06)
# define __MCS07_OFFSET0                __MCS_RAM1_SIZE
# define __MCS06_OFFSET1                __MCS_RAM0_SIZE

#elif __MCS_BORROW_MEM_MCS(06)
# define __MCS07_OFFSET0                0
...
#ifndef __MCS06_OFFSET0
# define __MCS06_OFFSET0                __MCS_RAM0_SIZE
#endif

#ifndef __MCS06_OFFSET1
# define __MCS06_OFFSET1                __MCS_RAM1_SIZE
#endif

#ifndef __MCS07_OFFSET0
# define __MCS07_OFFSET0                __MCS_RAM0_SIZE
#endif

#ifndef __MCS07_OFFSET1
# define __MCS07_OFFSET1                __MCS_RAM1_SIZE
#endif
...
// instance 00 (previous=07); RAM0 block
#if __MCS_SWAP_MEM_MCS(07)
# define __MCS00_MAP0_CORE      mcs07
# define __MCS00_MAP0_ADDR      __MCS07_OFFSET0

#elif __MCS_BORROW_MEM_MCS(07)
# define __MCS00_MAP0_CORE      mcs07
# define __MCS00_MAP0_ADDR      __MCS07_OFFSET0+__MCS07_OFFSET1

#elif __MCS_DEFAULT_MEM_MCS(07)
# define __MCS00_MAP0_CORE      mcs00
# define __MCS00_MAP0_ADDR      0

#endif

// MCS00 (previous=07); RAM1 block
#if __MCS_SWAP_MEM_MCS(00)
...
#if __MCS_SWAP_MEM_MCS(05)
# define __MCS05_MAP1_CORE      mcs06
...
// instance 06 (previous=05); RAM0 block
#if __MCS_SWAP_MEM_MCS(05)
# define __MCS06_MAP0_CORE      mcs05
# define __MCS06_MAP0_ADDR      __MCS05_OFFSET0

#elif __MCS_BORROW_MEM_MCS(05)
# define __MCS06_MAP0_CORE      mcs05
# define __MCS06_MAP0_ADDR      __MCS05_OFFSET0+__MCS05_OFFSET1

#elif __MCS_DEFAULT_MEM_MCS(05)
# define __MCS06_MAP0_CORE      mcs06
# define __MCS06_MAP0_ADDR      0

#endif

// MCS06 (previous=05); RAM1 block
#if __MCS_SWAP_MEM_MCS(06)
# define __MCS06_MAP1_CORE      mcs07
# define __MCS06_MAP1_ADDR      0

#elif __MCS_BORROW_MEM_MCS(06) || __MCS_DEFAULT_MEM_MCS(06)
# define __MCS06_MAP1_CORE      mcs06
# define __MCS06_MAP1_ADDR      __MCS06_OFFSET0

#endif

// instance 07 (previous=06); RAM0 block
#if __MCS_SWAP_MEM_MCS(06)
# define __MCS07_MAP0_CORE      mcs06
# define __MCS07_MAP0_ADDR      __MCS06_OFFSET0

#elif __MCS_BORROW_MEM_MCS(06)
# define __MCS07_MAP0_CORE      mcs06
# define __MCS07_MAP0_ADDR      __MCS06_OFFSET0+__MCS06_OFFSET1

#elif __MCS_DEFAULT_MEM_MCS(06)
# define __MCS07_MAP0_CORE      mcs07
# define __MCS07_MAP0_ADDR      0

#endif

// MCS07 (previous=06); RAM1 block
#if __MCS_SWAP_MEM_MCS(07)
# define __MCS07_MAP1_CORE      mcs00
# define __MCS07_MAP1_ADDR      0

#elif __MCS_BORROW_MEM_MCS(07) || __MCS_DEFAULT_MEM_MCS(07)
# define __MCS07_MAP1_CORE      mcs07
# define __MCS07_MAP1_ADDR      __MCS07_OFFSET0
...
//
        ...
        memory mcs06
        {
                ...
                map ram0 (dest=bus:aei, src_offset=0x0000, dest_offset=GTM_BASE_ADDR+MCS06_0RAM,                 size=__MCS_RAM0_SIZE);
                map ram1 (dest=bus:aei, src_offset=0x1000, dest_offset=GTM_BASE_ADDR+MCS06_0RAM+__MCS_RAM0_SIZE, size=__MCS_RAM1_SIZE);

                map mcs_ram0 (dest=bus:__MCS06_MAP0_CORE:mcs_bus, src_offset=0x0000, dest_offset=__MCS06_MAP0_ADDR, size=__MCS_RAM0_SIZE);
                map mcs_ram1 (dest=bus:__MCS06_MAP1_CORE:mcs_bus, src_offset=0x1000, dest_offset=__MCS06_MAP1_ADDR, size=__MCS_RAM1_SIZE);
        }
        ...
        memory mcs07
        {
                ...
                map ram0 (dest=bus:aei, src_offset=0x0000, dest_offset=GTM_BASE_ADDR+MCS07_0RAM,                 size=__MCS_RAM0_SIZE);
                map ram1 (dest=bus:aei, src_offset=0x1000, dest_offset=GTM_BASE_ADDR+MCS07_0RAM+__MCS_RAM0_SIZE, size=__MCS_RAM1_SIZE);

                map mcs_ram0 (dest=bus:__MCS07_MAP0_CORE:mcs_bus, src_offset=0x0000, dest_offset=__MCS07_MAP0_ADDR, size=__MCS_RAM0_SIZE);
                map mcs_ram1 (dest=bus:__MCS07_MAP1_CORE:mcs_bus, src_offset=0x1000, dest_offset=__MCS07_MAP1_ADDR, size=__MCS_RAM1_SIZE);
        }
