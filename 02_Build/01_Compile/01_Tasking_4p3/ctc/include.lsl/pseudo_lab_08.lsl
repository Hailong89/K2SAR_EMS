...
#define MCS04_0RAM              0x78000
#define MCS05_0RAM              0x88000
#define MCS06_0RAM              0x98000
#define MCS07_0RAM              0xA8000
...
#if __MCS_SWAP_MEM_MCS(07)
# define __MCS00_BLOCK_0_ADDR   MCS07_0RAM - MCS00_0RAM + __MCS_RAM0_SIZE
...
# define __MCS03_BLOCK_1_ADDR   MCS04_0RAM - MCS03_0RAM
...
# define __MCS03_BLOCK_2_ADDR   MCS04_0RAM - MCS03_0RAM
...
# define __MCS04_BLOCK_1_ADDR   MCS05_0RAM - MCS04_0RAM
# define __MCS04_BLOCK_1_SIZE   __MCS_RAM0_SIZE
#endif

#if __MCS_SWAP_MEM_MCS(03)
# define __MCS04_BLOCK_0_ADDR   MCS03_0RAM - MCS04_0RAM + __MCS_RAM0_SIZE
# define __MCS04_BLOCK_0_SIZE   __MCS_RAM1_SIZE
#endif

#if __MCS_BORROW_MEM_MCS(04)
# define __MCS04_BLOCK_2_ADDR   MCS05_0RAM - MCS04_0RAM
# define __MCS04_BLOCK_2_SIZE   __MCS_RAM0_SIZE
#endif

#if __MCS_BORROW_MEM_MCS(03)
# define __MCS04_BLOCK_0_ADDR   0x0
# define __MCS04_BLOCK_0_SIZE   0x0
#endif

#ifndef __MCS04_BLOCK_0_ADDR
# define __MCS04_BLOCK_0_ADDR   0x0
#endif

#ifndef __MCS04_BLOCK_0_SIZE
# define __MCS04_BLOCK_0_SIZE   __MCS_RAM0_SIZE
#endif

#ifndef __MCS04_BLOCK_1_ADDR
# define __MCS04_BLOCK_1_ADDR   __MCS_RAM0_SIZE
#endif

#ifndef __MCS04_BLOCK_1_SIZE
# define __MCS04_BLOCK_1_SIZE   __MCS_RAM1_SIZE
#endif

#ifndef __MCS04_BLOCK_2_ADDR
# define __MCS04_BLOCK_2_ADDR   0x0
#endif

#ifndef __MCS04_BLOCK_2_SIZE
# define __MCS04_BLOCK_2_SIZE   0x0
#endif

// MCS05
#if __MCS_SWAP_MEM_MCS(05)
# define __MCS05_BLOCK_1_ADDR   MCS06_0RAM - MCS05_0RAM
# define __MCS05_BLOCK_1_SIZE   __MCS_RAM0_SIZE
#endif

#if __MCS_SWAP_MEM_MCS(04)
# define __MCS05_BLOCK_0_ADDR   MCS04_0RAM - MCS05_0RAM + __MCS_RAM0_SIZE
# define __MCS05_BLOCK_0_SIZE   __MCS_RAM1_SIZE
#endif

#if __MCS_BORROW_MEM_MCS(05)
# define __MCS05_BLOCK_2_ADDR   MCS06_0RAM - MCS05_0RAM
# define __MCS05_BLOCK_2_SIZE   __MCS_RAM0_SIZE
#endif

#if __MCS_BORROW_MEM_MCS(04)
# define __MCS05_BLOCK_0_ADDR   0x0
# define __MCS05_BLOCK_0_SIZE   0x0
#endif

#ifndef __MCS05_BLOCK_0_ADDR
# define __MCS05_BLOCK_0_ADDR   0x0
#endif

#ifndef __MCS05_BLOCK_0_SIZE
# define __MCS05_BLOCK_0_SIZE   __MCS_RAM0_SIZE
#endif

#ifndef __MCS05_BLOCK_1_ADDR
# define __MCS05_BLOCK_1_ADDR   __MCS_RAM0_SIZE
#endif

#ifndef __MCS05_BLOCK_1_SIZE
# define __MCS05_BLOCK_1_SIZE   __MCS_RAM1_SIZE
#endif

#ifndef __MCS05_BLOCK_2_ADDR
# define __MCS05_BLOCK_2_ADDR   0x0
#endif

#ifndef __MCS05_BLOCK_2_SIZE
# define __MCS05_BLOCK_2_SIZE   0x0
#endif

// MCS06
#if __MCS_SWAP_MEM_MCS(06)
# define __MCS06_BLOCK_1_ADDR   MCS07_0RAM - MCS06_0RAM
# define __MCS06_BLOCK_1_SIZE   __MCS_RAM0_SIZE
#endif

#if __MCS_SWAP_MEM_MCS(05)
# define __MCS06_BLOCK_0_ADDR   MCS05_0RAM - MCS06_0RAM + __MCS_RAM0_SIZE
# define __MCS06_BLOCK_0_SIZE   __MCS_RAM1_SIZE
#endif

#if __MCS_BORROW_MEM_MCS(06)
# define __MCS06_BLOCK_2_ADDR   MCS07_0RAM - MCS06_0RAM
# define __MCS06_BLOCK_2_SIZE   __MCS_RAM0_SIZE
#endif

#if __MCS_BORROW_MEM_MCS(05)
# define __MCS06_BLOCK_0_ADDR   0x0
# define __MCS06_BLOCK_0_SIZE   0x0
#endif

#ifndef __MCS06_BLOCK_0_ADDR
# define __MCS06_BLOCK_0_ADDR   0x0
#endif

#ifndef __MCS06_BLOCK_0_SIZE
# define __MCS06_BLOCK_0_SIZE   __MCS_RAM0_SIZE
#endif

#ifndef __MCS06_BLOCK_1_ADDR
# define __MCS06_BLOCK_1_ADDR   __MCS_RAM0_SIZE
#endif

#ifndef __MCS06_BLOCK_1_SIZE
# define __MCS06_BLOCK_1_SIZE   __MCS_RAM1_SIZE
#endif

#ifndef __MCS06_BLOCK_2_ADDR
# define __MCS06_BLOCK_2_ADDR   0x0
#endif

#ifndef __MCS06_BLOCK_2_SIZE
# define __MCS06_BLOCK_2_SIZE   0x0
#endif

// MCS07
#if __MCS_SWAP_MEM_MCS(07)
# define __MCS07_BLOCK_1_ADDR   MCS00_0RAM - MCS07_0RAM
# define __MCS07_BLOCK_1_SIZE   __MCS_RAM0_SIZE
#endif

#if __MCS_SWAP_MEM_MCS(06)
# define __MCS07_BLOCK_0_ADDR   MCS06_0RAM - MCS07_0RAM + __MCS_RAM0_SIZE
# define __MCS07_BLOCK_0_SIZE   __MCS_RAM1_SIZE
#endif

#if __MCS_BORROW_MEM_MCS(07)
# define __MCS07_BLOCK_2_ADDR   MCS00_0RAM - MCS07_0RAM
# define __MCS07_BLOCK_2_SIZE   __MCS_RAM0_SIZE
#endif

#if __MCS_BORROW_MEM_MCS(06)
# define __MCS07_BLOCK_0_ADDR   0x0
# define __MCS07_BLOCK_0_SIZE   0x0
#endif

#ifndef __MCS07_BLOCK_0_ADDR
# define __MCS07_BLOCK_0_ADDR   0x0
#endif

#ifndef __MCS07_BLOCK_0_SIZE
# define __MCS07_BLOCK_0_SIZE   __MCS_RAM0_SIZE
#endif

#ifndef __MCS07_BLOCK_1_ADDR
# define __MCS07_BLOCK_1_ADDR   __MCS_RAM0_SIZE
#endif

#ifndef __MCS07_BLOCK_1_SIZE
# define __MCS07_BLOCK_1_SIZE   __MCS_RAM1_SIZE
#endif

#ifndef __MCS07_BLOCK_2_ADDR
# define __MCS07_BLOCK_2_ADDR   0x0
#endif

#ifndef __MCS07_BLOCK_2_SIZE
# define __MCS07_BLOCK_2_SIZE   0x0
#endif
...
//
        ...
        section_layout :vtc:linear
        {
                ...
                "_lc_le_mcs03_b2" = 0;
#endif
#if     __MCS04_BLOCK_0_SIZE != 0
                "_lc_lb_mcs04_b0" = GTM_BASE_ADDR + MCS04_0RAM + __MCS04_BLOCK_0_ADDR;
                "_lc_le_mcs04_b0" = "_lc_lb_mcs04_b0" + __MCS04_BLOCK_0_SIZE;
                "_lc_lb_mcs04_b1" = GTM_BASE_ADDR + MCS04_0RAM + __MCS04_BLOCK_1_ADDR;
                "_lc_le_mcs04_b1" = "_lc_lb_mcs04_b1" + __MCS04_BLOCK_1_SIZE;
#else
                "_lc_lb_mcs04_b0" = 0;
                "_lc_le_mcs04_b0" = 0;
                "_lc_lb_mcs04_b1" = GTM_BASE_ADDR + MCS04_0RAM + __MCS04_BLOCK_1_ADDR;
...
#if     __MCS04_BLOCK_2_SIZE != 0
                "_lc_lb_mcs04_b2" = GTM_BASE_ADDR + MCS04_0RAM + __MCS04_BLOCK_2_ADDR;
                "_lc_le_mcs04_b2" = "_lc_lb_mcs04_b2" + __MCS04_BLOCK_2_SIZE;
#else
                "_lc_lb_mcs04_b2" = 0;
                "_lc_le_mcs04_b2" = 0;
#endif
#if     __MCS05_BLOCK_0_SIZE != 0
                "_lc_lb_mcs05_b0" = GTM_BASE_ADDR + MCS05_0RAM + __MCS05_BLOCK_0_ADDR;
                "_lc_le_mcs05_b0" = "_lc_lb_mcs05_b0" + __MCS05_BLOCK_0_SIZE;
                "_lc_lb_mcs05_b1" = GTM_BASE_ADDR + MCS05_0RAM + __MCS05_BLOCK_1_ADDR;
                "_lc_le_mcs05_b1" = "_lc_lb_mcs05_b1" + __MCS05_BLOCK_1_SIZE;
#else
                "_lc_lb_mcs05_b0" = 0;
                "_lc_le_mcs05_b0" = 0;
                "_lc_lb_mcs05_b1" = GTM_BASE_ADDR + MCS05_0RAM + __MCS05_BLOCK_1_ADDR;
...
#if     __MCS05_BLOCK_2_SIZE != 0
                "_lc_lb_mcs05_b2" = GTM_BASE_ADDR + MCS05_0RAM + __MCS05_BLOCK_2_ADDR;
                "_lc_le_mcs05_b2" = "_lc_lb_mcs05_b2" + __MCS05_BLOCK_2_SIZE;
#else
                "_lc_lb_mcs05_b2" = 0;
                "_lc_le_mcs05_b2" = 0;
#endif
#if     __MCS06_BLOCK_0_SIZE != 0
                "_lc_lb_mcs06_b0" = GTM_BASE_ADDR + MCS06_0RAM + __MCS06_BLOCK_0_ADDR;
                "_lc_le_mcs06_b0" = "_lc_lb_mcs06_b0" + __MCS06_BLOCK_0_SIZE;
                "_lc_lb_mcs06_b1" = GTM_BASE_ADDR + MCS06_0RAM + __MCS06_BLOCK_1_ADDR;
                "_lc_le_mcs06_b1" = "_lc_lb_mcs06_b1" + __MCS06_BLOCK_1_SIZE;
#else
                "_lc_lb_mcs06_b0" = 0;
                "_lc_le_mcs06_b0" = 0;
                "_lc_lb_mcs06_b1" = GTM_BASE_ADDR + MCS06_0RAM + __MCS06_BLOCK_1_ADDR;
...
#if     __MCS06_BLOCK_2_SIZE != 0
                "_lc_lb_mcs06_b2" = GTM_BASE_ADDR + MCS06_0RAM + __MCS06_BLOCK_2_ADDR;
                "_lc_le_mcs06_b2" = "_lc_lb_mcs06_b2" + __MCS06_BLOCK_2_SIZE;
#else
                "_lc_lb_mcs06_b2" = 0;
                "_lc_le_mcs06_b2" = 0;
#endif
#if     __MCS07_BLOCK_0_SIZE != 0
                "_lc_lb_mcs07_b0" = GTM_BASE_ADDR + MCS07_0RAM + __MCS07_BLOCK_0_ADDR;
                "_lc_le_mcs07_b0" = "_lc_lb_mcs07_b0" + __MCS07_BLOCK_0_SIZE;
                "_lc_lb_mcs07_b1" = GTM_BASE_ADDR + MCS07_0RAM + __MCS07_BLOCK_1_ADDR;
                "_lc_le_mcs07_b1" = "_lc_lb_mcs07_b1" + __MCS07_BLOCK_1_SIZE;
#else
                "_lc_lb_mcs07_b0" = 0;
                "_lc_le_mcs07_b0" = 0;
                "_lc_lb_mcs07_b1" = GTM_BASE_ADDR + MCS07_0RAM + __MCS07_BLOCK_1_ADDR;
...
#if     __MCS07_BLOCK_2_SIZE != 0
                "_lc_lb_mcs07_b2" = GTM_BASE_ADDR + MCS07_0RAM + __MCS07_BLOCK_2_ADDR;
                "_lc_le_mcs07_b2" = "_lc_lb_mcs07_b2" + __MCS07_BLOCK_2_SIZE;
#else
                "_lc_lb_mcs07_b2" = 0;
                "_lc_le_mcs07_b2" = 0;
#endif
