...
//**  FILE        :  tc1792.lsl                                              *
//**                                                                         *
//**  DESCRIPTION :  LSL description: Infineon TC1792                        *
//**                                                                         *
...
derivative tc1792
{
        ...
        memory sram
        {
                ...
                size = 16k;
                type = reserved ram;
                map (dest=bus:tc:fpi_bus, dest_offset=0xc0000000, size=16k);
        }
        ...
        memory ldram
        {
                ...
                type = ram;
                speed = 2;
                map (dest=bus:tc:fpi_bus, dest_offset=0xd0000000, size=64k);
        }
        ...
        memory pcode
        {
                ...
                size = 16k;
                type = ram;
                map (dest=bus:tc:fpi_bus, dest_offset=0xf0060000, size=16k);
