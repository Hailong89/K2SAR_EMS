//****************************************************************************
//**                                                                         *
//**  FILE        :  @(#)userdef16x.lsl 1.20                                                 *
//**                                                                         *
//**  DESCRIPTION :  LSL description: User Defined TriCore v1.6.x Derivative *
//**                                                                         *
...
derivative tc27x
{
        ...
        memory dspr0 // Data Scratch Pad Ram
        {
                ...
                size = 112k;
                type = ram;
                map (dest=bus:tc0:fpi_bus, dest_offset=0xd0000000, size=112k, priority=2, exec_priority=0);
        ...
        memory pspr0 // Program Scratch Pad Ram
        {
                ...
                size = 24k;
                type = ram;
                map (dest=bus:tc0:fpi_bus, dest_offset=0xc0000000, size=24k, exec_priority=2);
...
memory xram
{
        ...
        map     cached (dest=bus:mpe:sri, dest_offset=0x80400000,           size=1M);
        map not_cached (dest=bus:mpe:sri, dest_offset=0xa0400000, reserved, size=1M);
}
