...
//**  FILE        :  tc1367.lsl                                              *
//**                                                                         *
//**  DESCRIPTION :  LSL description: Infineon TC1367                        *
//**                                                                         *
...
derivative tc1367
{
        ...
        memory pflash1
        {
                ...
                type = rom;
                speed = 2;
                map     cached (dest=bus:tc:fpi_bus, dest_offset=0x80400000,           size=1M);
                map not_cached (dest=bus:tc:fpi_bus, dest_offset=0xa0400000, reserved, size=1M);
        }
