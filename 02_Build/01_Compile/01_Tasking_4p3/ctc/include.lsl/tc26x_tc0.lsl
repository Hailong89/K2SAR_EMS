...
derivative tc26x
{
        ...
        memory dspr0 // Data Scratch Pad Ram
        {
                ...
                size = 72k;
                type = ram;
                map (dest=bus:tc0:fpi_bus, dest_offset=0xd0000000, size=72k, priority=2, exec_priority=0);
        ...
        memory pspr0 // Program Scratch Pad Ram
        {
                ...
                size = 16k;
                type = ram;
                map (dest=bus:tc0:fpi_bus, dest_offset=0xc0000000, size=16k, exec_priority=2);
