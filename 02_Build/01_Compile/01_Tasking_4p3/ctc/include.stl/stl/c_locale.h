...
#  endif
#elif 0 && defined (__TASKING__)
#  define _Locale_CNTRL  __C
#  define _Locale_UPPER  __U
#  define _Locale_LOWER  __L
#  define _Locale_DIGIT  __N
#  define _Locale_XDIGIT (__N | __X)
#  define _Locale_PUNCT  __P
#  define _Locale_SPACE  __S
#  define _Locale_PRINT  (__P | __U | __L | __N | __S)
#  define _Locale_ALPHA  (__U | __L)
#else
