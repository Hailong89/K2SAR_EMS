...
inline _Tp* value_type(const _STLP_PRIV _DBG_iter_base< _STLP_NON_DBG_VECTOR >&)
{ return (_Tp*)0; }
template <class _Tp, class _Alloc>
inline random_access_iterator_tag iterator_category(const _STLP_PRIV _DBG_iter_base< _STLP_NON_DBG_VECTOR >&)
    ...
    _STLP_PRIV __construct_checker< _STLP_NON_DBG_VECTOR >
{
  ...
  public:
    ...
    size_type capacity() const
      { return _M_non_dbg_impl.capacity(); }
    bool empty() const
    ...
    vector(size_type __n, const _Tp& __x, const allocator_type& __a = allocator_type()) :
...
#  endif
    ...
    vector(_InputIterator __first, _InputIterator __last, const allocator_type& __a _STLP_ALLOCATOR_TYPE_DFL) :
    ...
    void insert(iterator __pos, _InputIterator __first, _InputIterator __last)
      {
         ...
         _M_non_dbg_impl.insert(__pos._M_iterator, _STLP_PRIV _Non_Dbg_iter(__first), _STLP_PRIV _Non_Dbg_iter(__last));
