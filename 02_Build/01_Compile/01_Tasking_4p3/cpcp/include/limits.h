...
#define CHAR_BIT	(32)		/* number of bits in a byte */
#define SCHAR_MIN	(-SCHAR_MAX-1)	/* minimum value of signed char */
#define SCHAR_MAX	(0x7fffffff)  	/* maximum value of signed char */
#define UCHAR_MAX	(0xffffffffU) 	/* maximum value of unsigned char */
...
#define SHRT_MAX	(0x7fffffff)	/* maximum value of short int */
#define USHRT_MAX	(0xffffffffU)	/* maximum value of unsigned short */
